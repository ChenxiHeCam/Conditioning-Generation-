...
#SBATCH -o /home/ch2067/rds/hpc-work/21cm_gen/logs/setup_%j.out
#SBATCH -e /home/ch2067/rds/hpc-work/21cm_gen/logs/setup_%j.err
...
conda env remove -n ldm -y 2>/dev/null || true
conda create -y -n ldm python=3.11
source activate ldm

ENV=/home/ch2067/.conda/envs/ldm
$ENV/bin/pip install --upgrade pip
$ENV/bin/pip install torch==2.4.0 numpy==1.26.4 scipy==1.11.4 matplotlib scikit-learn
