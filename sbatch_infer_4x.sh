...
#SBATCH -o /home/ch2067/rds/hpc-work/21cm_gen/logs/infer_4x_%j.out
#SBATCH -e /home/ch2067/rds/hpc-work/21cm_gen/logs/infer_4x_%j.err

mkdir -p /home/ch2067/rds/hpc-work/21cm_gen/eval_results/ff_4x
module purge
...
/home/ch2067/.conda/envs/ldm/bin/python infer_baselines.py \
  ...
  --out_dir   /home/ch2067/rds/hpc-work/21cm_gen/eval_results/ff_4x \
  --split test \
  --redshift 10 \
  --n_cubes 100 \
  --steps 30
