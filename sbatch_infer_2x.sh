...
#SBATCH -o /home/ch2067/rds/hpc-work/21cm_gen/logs/infer_2x_%j.out
#SBATCH -e /home/ch2067/rds/hpc-work/21cm_gen/logs/infer_2x_%j.err

mkdir -p /home/ch2067/rds/hpc-work/21cm_gen/eval_results/ff_2x
module purge
...
/home/ch2067/.conda/envs/ldm/bin/python infer_baselines.py \
  ...
  --out_dir   /home/ch2067/rds/hpc-work/21cm_gen/eval_results/ff_2x \
  --split test \
  --redshift 10 \
  --n_cubes 100 \
  --steps 30
