...
#SBATCH -o /home/ch2067/rds/hpc-work/21cm_gen/logs/infer_4x_mz_%j.out
#SBATCH -e /home/ch2067/rds/hpc-work/21cm_gen/logs/infer_4x_mz_%j.err
...
for z in 7 8 9 10 11 12 13; do
    ...
    OUT=/home/ch2067/rds/hpc-work/21cm_gen/eval_results/ff_4x_z${z}
